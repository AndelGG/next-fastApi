...
import { BACKEND_API_URL, WEBSOCKET_API_URL } from "@/etc/constants";
...
export default function PlayGame({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        const ws = new WebSocket(`${WEBSOCKET_API_URL}/games/ws/${params.id}/`);
        ws.addEventListener("open", () => {
            fetch(`${BACKEND_API_URL}/games/${params.id}/`)
                .then((response) => {
